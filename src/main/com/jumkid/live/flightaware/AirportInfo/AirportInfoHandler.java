 ...
 *
 */
public class AirportInfoHandler {
	 ...
	 * @return
	 */
	public AirportInfoResponse request(Map<String, Object> parameters){
		...
		ResponseEntity<AirportInfoResponse> response =  restTemplate.exchange(APIUrl, HttpMethod.POST, entity, AirportInfoResponse.class);
