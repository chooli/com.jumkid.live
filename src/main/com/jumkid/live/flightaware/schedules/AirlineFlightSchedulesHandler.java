 ...
 *
 */
public class AirlineFlightSchedulesHandler {
	 ...
	 * @return
	 */
	public AirlineFlightSchedulesResponse request(Map<String, Object> parameters){
		...
		ResponseEntity<AirlineFlightSchedulesResponse> response =  restTemplate.exchange(APIUrl, HttpMethod.POST, entity, AirlineFlightSchedulesResponse.class);
